...
export default function DashComments() {
  ...
  const [commentIdToDelete,setShowCommentIdToDelete]=useState('');
  ...
  return (
    <div className='table-auto overflow-x-scroll md:mx-auto p-3 scrollbar scrollbar-track-slate-100 scrollbar-thumb-slate-300 dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500 '>
         ...
         <Table.Cell>
           {comment.userId}
             ...
             <Table.Cell>
               ...
               setShowCommentIdToDelete(comment._id)
              }} className=' font-medium text-red-500 hover:underline cursor-pointer'>Delete</span>
             </Table.Cell>

             <Table.Cell>
               <span className=' font-medium text-green-400 hover:underline cursor-pointer'>Apply Analysis</span>
             </Table.Cell>
                </Table.Row>
       ...
       <h3  className='mb-5 text-lg text-gray-500 dark:to-gray-400' >Are you sure want to delete this comment  </h3>
